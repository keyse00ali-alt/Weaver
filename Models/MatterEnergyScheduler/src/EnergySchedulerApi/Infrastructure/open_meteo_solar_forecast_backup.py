...
class OpenMeteoSolarForecast:
    ...
    def _save_forecast_to_cache(
        ...
        try:
            ...
            # Silently fail caching - don't disrupt service
            pass
    ...
    async def get_forecast(
        ...
        try:
            ...
            if cached_productions:
                ...
                print(f"Using previous day's solar forecast ({previous_date}) as fallback for {target_date}")
                return fallback_productions
            else:
                # No cache available either
                raise ValueError(f"Failed to fetch Open-Meteo forecast and no previous day cache available: {str(e)}")
